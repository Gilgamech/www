...
$ARKDataWebDir = "C:\Dropbox\repos\www\ARKData" #Where ARKData writes its website files.
#
#
#
#
...
Function Start-ARKDataTask {
	...
	start-job { ipmo "C:\Dropbox\repos\www\ARKData\bin\ARKData.ps1" ; Run-ARKDataTask -serverip "104.156.227.231" -serverport 27040 }

	#GILARK
	#start-job { ipmo "C:\Dropbox\Public\Scripts\Powershell\ARKData\ARKData.ps1" ; Run-ARKDataTask -serverip "24.16.204.32" -serverport 27015 }
...
Function Run-ARKDataTask {
	...
	$ARKDataBinDir
	while ($true) {
		$ARKDataBinDir = "C:\Dropbox\repos\www\ARKData\bin"
...
<link rel="stylesheet" type="text/css" charset="utf-8" href="http://gilgamech.com/ARKData/ARKData.css">
<link rel="stylesheet" type="text/css" charset="utf-8" href="http://gilgamech.com/ARKData/ARKDatam.css" media="handheld" />
...
<nav>
	...
	<a href="http://gilgamech.com/ARKData/index.html">ARKData!</a> | 
</nav>
<div class="content">
...
<br>
<p class="banner">
	<a href="/ARKData/Images/A0Oqmx8.png"><img src="/ARKData/Images/A0Oqmx8.png" title="C1ick h34r ph0r m04r inph0" /></a>
</p>
</body></html>
'@
