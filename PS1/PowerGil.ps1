# C:\Dropbox\repos\www\PS1\PowerGIL.ps1 Build: 548 2017-01-26T09:53:53 Copyright Gilgamech Technologies  
# Update Path: http://Gilgamech.com/PS1/PowerGIL.ps1
# Build : LineNo : Update Notes
# 544 : 873 :   [switch]$Javascript,
# 545 : 876 : If _$Javascript_ _  #a _; #end If Javascript
# 546 : 873 :   [string]$Language,
# 547 : 876 : Switch _$Language_ _  #a _; #end Switch Language
# 548 : 800 :  #_ $NewLineVar
...
.DESCRIPTION
	...
	Last edit: 5/9/2016
	Build: 1
	Copyright: Gilgamech Technologies
.INSTALLLOCATION
	C:\Dropbox\Public\html5\PS1\PowerGIL.ps1
.UPDATELOCATION
	http://Gilgamech.com/PS1/PowerGIL.ps1
.LINK
.UPDATEHISTORY
# Build : LineNo : Update Notes
# 536 : 1568 : _Status.last_updated _ get_date __Status.last_updated _replace _Z_,_
# 537 : 562 :  Build_ 1
# 538 : 632 :  Build_ 1
# 539 : 632 :  Build_ 1
# 540 : 10 : _# .SYNOPSIS  Inserts the supplied text into the target module at the listed line number. .DESCRIPTION  Author: Gilgamech  Last edit: 5/9/2016  Build_ 1 .Parameter Frequency  Required.  VMWare Performance Graph from which the CPU Ready value was taken. .Parameter CPUReadyValue  Required.  CPU Ready value from the VMWare Performance Graph.  .EXAMPLE  New_FunctionStatement .\PowerShiriAdmin.ps1 289 _nos .INPUTS  [string]  [int]  [switch] .OUTPUTS  [string] [int] .LINK  https://kb.vmware.com/selfservice/microsites/search.do?language=en_US&cmd=displayKC&externalId=2002181 #_ 
#>
...
#>
	Param(
		...
		[switch]$PipePlus,
		[switch]$SetVerbose,
		[ValidateSet("Powershell", "Javascript")][string]$Language,
		[switch]$NoComma
	); #end Param
	Switch ($Language) {
		"Powershell" {
...
Function Get-GithubStatus {
	$Status = Invoke-RestMethod -Uri "https://status.github.com/api/status.json"
...
Function Convert-SpaceDeltoHyphenDel {
	Param(
...
Function ConvertFrom-ParagraphtoBulletList {
	...
	$String = $String -replace  "[.] ",".`n- " -replace  "[?] ","?`n- " -replace  "[!] ","!`n- " -replace  "[:] ",":`n- " -replace  "[;] ",";`n- "
...
#http://powershell.org/wp/2014/02/01/revisited-powershell-and-encryption/
	...
	$CipherTextKey = 102, 59, 50, 40, 94, 33, 97, 112, 114, 35, 54, 53, 62, 103, 109, 89, 52, 37, 64, 85, 63, 125, 77, 45, 36, 76, 83, 38, 13, 100, 34, 88, 70, 32, 87, 69, 105, 51, 74, 101, 68, 41, 78, 82, 104, 56, 48, 66, 93, 86, 58, 79, 120, 67, 110, 115, 118, 111, 126, 95, 119, 49, 47, 121, 123, 73, 99, 116, 107, 39, 61, 98, 96, 46, 72, 9, 117, 43, 80, 122, 71, 10, 75, 92, 60, 65, 124, 81, 42, 57, 90, 55, 106, 84, 113, 108, 44, 91;
...
<#
#Setup guide:
#Administrator Powershell # Set-ExecutionPolicy Unrestricted # Y
if (Test-Path $PROFILE) {rm $PROFILE}
$ir = Invoke-WebRequest http://www.gilgamech.com/ps1/powergil.ps1
split-path $profile
$ir.content > ((split-path $profile) + "PowerGIL.ps1")
$c = gc ((split-path $profile) + "PowerGIL.ps1")
md (split-path $profile)
$c[11..21] | foreach { $_ = $_ -replace '#','' } > $profile
'if (test-path $PowerGIL) {ipmo $PowerGIL} else {ipmo ((split-path $profile) + "PowerGIL.ps1")}' >> $Profile
#>
